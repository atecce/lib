...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_book_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_book_rustbuffer_free(self, $0) }
    }
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeBook: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Book {
        return
            try Book(
                name: FfiConverterTypeName.read(from: &buf)
        )
    }

    public static func write(_ value: Book, into buf: inout [UInt8]) {
        FfiConverterTypeName.write(value.name, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBook_lift(_ buf: RustBuffer) throws -> Book {
    return try FfiConverterTypeBook.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBook_lower(_ value: Book) -> RustBuffer {
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_book_uniffi_contract_version()
...
public func uniffiEnsureBookInitialized() {
