...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_bible_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_bible_rustbuffer_free(self, $0) }
    }
}
...
public struct Source: Equatable, Hashable {
    ...
    public init(book: Name, chapter: UInt8, start: UInt8, end: UInt8?) {
        self.book = book
...
public struct FfiConverterTypeSource: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Source {
        return
            try Source(
                ...
                start: FfiConverterUInt8.read(from: &buf), 
                end: FfiConverterOptionUInt8.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: Source, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt8.write(value.start, into: &buf)
        FfiConverterOptionUInt8.write(value.end, into: &buf)
    }
}
...
public func uniffiEnsureBibleInitialized() {
